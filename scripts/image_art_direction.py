...
def build_image_prompt(spec, runtime, *, banner=False, brand_context=""):
    ...
    template_name = str(template.get("name") or "Apple 极简留白")
    ...
    lines = [
        ...
        "Base visual language: Apple 官网式现代主义极简 — restrained color, extreme whitespace, modern sans-serif, title medium-bold, body light, numbers light, full-width sections, hairline rules, micro-radius, no decorative gradients.",
        ...
        "Material quality comes from exact typography, 1.5x vertical spacing, sharp registration and precise alignment. No lighting effects, simulated plastic, embossed icons, decorative gradients, drop shadows, ornamental borders or closed card stacks.",
        ...
        "Use generous whitespace and hairline rules to separate ideas. Information itself is the hero. Do not wrap every fact in a box, pill or tile. Prefer empty space over filler. No decorative illustration is needed for a metric-led card.",
