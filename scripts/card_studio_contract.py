    ...
    *,
    ...
    gates: List[Dict[str, Any]] = [
        ...
        _gate(
            ...
            severity="error",
            description="视觉卡片具备 Seedream 5.0 Pro 或 Seedance 2.5 溯源和真实 img_key；无图卡片不受此门影响。",
            evidence={"image_required": image_required, "visual_output_ready": visual_output_ready, "image_ready": image_ready},
        ),
    ]
